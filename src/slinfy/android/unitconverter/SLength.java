...
public class SLength extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Kilometers", "km");
		googleUnits.put("Meters", "m");
		googleUnits.put("Centimeters", "cm");
		googleUnits.put("Miles", "miles");
		googleUnits.put("Feet", "feet");
		googleUnits.put("Angstroms", "angstroms");
		googleUnits.put("Cubits", "cubits");
		googleUnits.put("Furlongs", "furlongs");
		
		final String cities[][] = new String[][] { new String[] { "Kilometers", "Meters", "Feet", "Centimeters", "Miles", "Angstroms", "Cubits", "Furlongs" } };
