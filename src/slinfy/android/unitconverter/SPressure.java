...
public class SPressure extends Activity {
	// Scrolling flag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Bar", "bar");
		googleUnits.put("Pascal", "Pa");
		googleUnits.put("Pounds/sq.inch", "psi");
		googleUnits.put("Atmospheres", "atm");
		googleUnits.put("Inch Mercury", "inHg");
		googleUnits.put("Torr", "torr");
		googleUnits.put("Kilogram/sq.meter", "kg/sq%20m");
		googleUnits.put("Kilogram/sq.feet", "kg/sq%20feet");

		final String cities[][] = new String[][] { new String[] { "Bar",
				"Pascal", "Pounds/sq.inch", "Atmospheres", "Inch Mercury",
				"Torr" } };
