...
public class SEnergy extends Activity {
	// Scrolling flag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Calories", "calories");
		googleUnits.put("British thermal units", "btu");
		googleUnits.put("Joules", "joules");
		googleUnits.put("Ergs", "ergs");
		googleUnits.put("Foot-Pounds", "foot-pounds");

		final String cities[][] = new String[][] { new String[] { "Calories",
				"British thermal units", "Joules", "Ergs", "Foot-Pounds" } };
