...
public class SInformation extends Activity {
	// Scrolling flag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Bits", "bits");
		googleUnits.put("Bytes", "bytes");
		googleUnits.put("Kilobytes", "kilobytes");
		googleUnits.put("Gigabytes", "gigabytes");
		googleUnits.put("Terabytes", "terabytes");
		googleUnits.put("Pentabytes", "petabytes");

		final String cities[][] = new String[][] { new String[] { "Bits",
				"Bytes", "Kilobytes", "Gigabytes", "Terabytes", "Pentabytes" } };
