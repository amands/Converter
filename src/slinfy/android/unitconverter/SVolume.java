...
public class SVolume extends Activity {
	// Scrolling flag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Gallon","gallon");
		googleUnits.put("Liters","liters");
		googleUnits.put("Pints","pints");
		googleUnits.put("Cups","cups");
		googleUnits.put("Tablespoons","tablespoons");
		googleUnits.put("Teaspoons","teaspoons");
		googleUnits.put("Cubic Feet","cubic%20feet");
		googleUnits.put("Cubic meters","cubic%20meters");
		googleUnits.put("Cubic centimeters","cubic%20centimeters");
		googleUnits.put("Cubic feet","cubic%20feet");
		googleUnits.put("Cubic inch","cubic%20inch");
		googleUnits.put("Fluid Ounces","fl%20oz");
		googleUnits.put("Quarts","quarts");
		googleUnits.put("Drams","drams");

		final String cities[][] = new String[][] { new String[] { "Gallon",
				"Liters", "Pints", "Cups", "Tablespoons", "Teaspoons", "Cubic Feet",
				"Cubic meters", "Cubic centimeters", "Cubic feet",
				"Cubic inch", "Fluid Ounces", "Quarts", "Drams" } };
