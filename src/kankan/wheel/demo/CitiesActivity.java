...
//		Warehouse collector	= (Warehouse)getApplicationContext();
        ...
        final String cities[][] = new String[][] {
        		new String[] {""},
        		new String[] {""},
        		new String[] {"Fahrenheit", "Celsius", "Kelvin"},
...
//                updateCities(city, cities, country.getCurrentItem());
        ...
        etFrom.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before,int count) {
				...
				String element1 = (String) googleUnits.get(cities[Selected][country.getCurrentItem()]);
				String element2 = (String) googleUnits.get(cities[Selected][city.getCurrentItem()]);
