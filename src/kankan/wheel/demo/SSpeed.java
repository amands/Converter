...
public class SSpeed extends Activity {
	// Scrolling flag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Miles/hour","mph");
		googleUnits.put("Km/hour","km/h");
		googleUnits.put("Km/second","km/s");
		googleUnits.put("Meters/second","m/s");

		final String cities[][] = new String[][] { new String[] {
				"Miles/hour", "Km/hour", "Km/second", "Meters/second"} };
