...
public class SMass extends Activity {
	// Scrolling flag
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		googleUnits.put("Stones", "stones");
		googleUnits.put("Kilogram", "kg");
		googleUnits.put("Grams", "gl");
		googleUnits.put("Grains", "grains");
		googleUnits.put("Pounds", "lbs");
		googleUnits.put("Carats", "carats");
		googleUnits.put("Stones", "stones");
		googleUnits.put("Tons", "tons");
		googleUnits.put("Tonnes", "tonnes");
		
		final String cities[][] = new String[][] { new String[] { "Stones", "Kilogram", "Grams", "Grains", "Pounds", "Carats", "Stones","Tons", "Tonnes"} };
